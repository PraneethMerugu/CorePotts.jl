...
include("program/status.jl")
include("execution/acceptance.jl")
include("program/compiled_program.jl")
include("execution/hamiltonian_runtime.jl")
include("execution/checkerboard_requirements.jl")
include("execution/gathered_proposal_evaluation.jl")
include("execution/checkerboard_science.jl")
